...
// Validate ../../app/api/wallet-login/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/wallet-login">> = Specific
  const handler = {} as typeof import("../../app/api/wallet-login/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
